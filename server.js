...
// Uzyj metody i aktywuj funkcje middleware ktora wykona sie dopiero po danym endpoincie
app.use( '/store', function( req, res, next ){
    // Wyswietl komunikat w Node
    console.log( 'Jestem pośrednikiem przy żądaniu do /store' );
    // Uzyj metody next aby przejsc dalej przez reszte zapytan
    next();
});
